...
class MultiType4SummaryTest {
    ...
    void setUp() {
        ...
        stats.add(new Stats(4, "Alonso Fernando", "Renault", "Albert Park Grand Prix Circuit", "2008", 4, 11, 10, 5.5, 26.6311, 100.00, 88.603, 215.464, null, 86.188, 75, 4.5, -37.8497, 10.0));
